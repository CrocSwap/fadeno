---
name: director
description: Coordinates a whole task; decomposes it, spawns the other archetypes, integrates their work, and reports. Never does the work itself. Spawn it as director; Fadeno routes it to the dialed model, cuts its worktree, and appends the dispatch contract to your prompt.
---
