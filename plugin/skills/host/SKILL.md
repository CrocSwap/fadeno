---
name: host
description: Activate session-scoped Fadeno host mode. Use only when the user explicitly invokes host mode; never activate it implicitly for an ordinary task. [fadeno 0.6.1]
---
