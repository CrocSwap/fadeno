---
name: judge
description: Evaluator role for Fadeno playbooks — scores competing attempts and emits a structured judgment. Use when a Fadeno playbook delegates judging/evaluation to a subagent. [fadeno 0.6.0-rc.19]
---
