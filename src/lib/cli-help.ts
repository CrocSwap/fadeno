...
const PAGE_OPTIONS: Record<string, readonly string[]> = {
  ...
  dispatches: withGlobals('--tail', '--json', '--bakeoffs', '--output', '--wait', '--tag', '--cancel', '--merge', '--allow-relay-mismatch'),
