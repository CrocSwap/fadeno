---
name: fadeno-setup
description: Link the Fadeno CLI onto PATH for this user. Use when the user asks to set up Fadeno, install its local integration, or when `fadeno` is not found on PATH.
---
