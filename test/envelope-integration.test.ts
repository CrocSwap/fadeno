...
`;
  ...
  const execYaml = {
    ...
    models: { m: { provider: 'dummy', id: 'm', effort: 'high' } },
    routes: {
      standalone: { dummy: { command, write_access: true }, 'current-host': { host: true } },
      codex: { dummy: { command, write_access: true }, 'current-host': { host: true } },
      claude: { dummy: { command, write_access: true }, 'current-host': { host: true } },
      grok: { dummy: { command, write_access: true }, 'current-host': { host: true } },
    },
    archetypes: { worker: {} },
    bindings: { agent_1: 'm' },
  };
